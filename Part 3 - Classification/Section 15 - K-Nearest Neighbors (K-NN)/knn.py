...
visualizeClassification(classifier, X_train, Y_train, 'red', 'green', 'K-NN classification (training)')
visualizeClassification(classifier, X_test, Y_test, 'red', 'green', 'K-NN classification (test)')
