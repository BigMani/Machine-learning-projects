...
visualizeClassification(classifier, X_train, Y_train, 'red', 'green', ' SVM classifier (training)')
visualizeClassification(classifier, X_test, Y_test, 'red', 'green', ' SVM classifier (test)')
