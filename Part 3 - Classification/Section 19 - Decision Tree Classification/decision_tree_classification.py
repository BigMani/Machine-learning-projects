...
visualizeClassification(classifier, X_train, Y_train, 'red', 'green', ' Decision tree classifier (training)')
visualizeClassification(classifier, X_test, Y_test, 'red', 'green', ' Decision tree classifier (test)')
